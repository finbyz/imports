...
doc_events = {
	"Sales Invoice": {
		"on_update": "imports.api.export_on_submit",
		"on_cancel": "imports.api.export_on_cancel"	
	},
	"Purchase Invoice": {
		"on_update": "imports.api.import_on_submit",
		"on_cancel": "imports.api.import_on_cancel"	
	}
}
